...
RCT_EXPORT_METHOD(initialize : (NSString *)apiKey userId : (NSString *)userId settings : (NSDictionary *)
                      settings resolver : (RCTPromiseResolveBlock)resolve rejecter : (RCTPromiseRejectBlock)reject) {
...
RCT_EXPORT_METHOD(getRealtimeMetrics : (float)periodSec resolver : (RCTPromiseResolveBlock)
...
RCT_EXPORT_METHOD(setCustomMeasurementConfig : (NSDictionary *)config resolver : (RCTPromiseResolveBlock)
                      resolve rejecter : (RCTPromiseRejectBlock)reject) {
  if (!config) {
...
RCT_EXPORT_METHOD(setCustomColorTheme : (NSDictionary *)theme resolver : (RCTPromiseResolveBlock)
                      resolve rejecter : (RCTPromiseRejectBlock)reject) {
  if (!theme) {
...
RCT_EXPORT_METHOD(getMeasurementResultsHistory : (RCTPromiseResolveBlock)resolve rejecter : (RCTPromiseRejectBlock)
                      reject) {
...
RCT_EXPORT_METHOD(getShowFacePositioningOverlay : (RCTPromiseResolveBlock)resolve rejecter : (RCTPromiseRejectBlock)
                      reject) {
...
RCT_EXPORT_METHOD(getEnableStartAfterSuccess : (RCTPromiseResolveBlock)resolve rejecter : (RCTPromiseRejectBlock)
                      reject) {
...
RCT_EXPORT_METHOD(getMeasurementProgressPercentage : (RCTPromiseResolveBlock)resolve rejecter : (RCTPromiseRejectBlock)
                      reject) {
...
RCT_EXPORT_METHOD(getRealtimeHeartbeats : (nullable NSNumber *)periodSec resolver : (RCTPromiseResolveBlock)
                      resolve rejecter : (RCTPromiseRejectBlock)reject) {
...
RCT_EXPORT_METHOD(getCurrentSignalQualityMetric : (RCTPromiseResolveBlock)resolve rejecter : (RCTPromiseRejectBlock)
                      reject) {
...
RCT_EXPORT_METHOD(computeHealthRisks : (NSDictionary *)factorsDict resolver : (RCTPromiseResolveBlock)
                      resolve rejecter : (RCTPromiseRejectBlock)reject) {
...
RCT_EXPORT_METHOD(getMaximalRisks : (NSDictionary *)factorsDict resolver : (RCTPromiseResolveBlock)
                      resolve rejecter : (RCTPromiseRejectBlock)reject) {
  RisksFactors *factors = [self risksFactorsFromDictionary:factorsDict];
...
RCT_EXPORT_METHOD(getMinimalRisks : (NSDictionary *)factorsDict resolver : (RCTPromiseResolveBlock)
                      resolve rejecter : (RCTPromiseRejectBlock)reject) {
  RisksFactors *factors = [self risksFactorsFromDictionary:factorsDict];
...
RCT_EXPORT_METHOD(getReferenceRisks : (NSDictionary *)factorsDict resolver : (RCTPromiseResolveBlock)
                      resolve rejecter : (RCTPromiseRejectBlock)reject) {
  RisksFactors *factors = [self risksFactorsFromDictionary:factorsDict];
...
RCT_EXPORT_METHOD(openMeasurementResultsPdfInBrowser : (RCTPromiseResolveBlock)
                      resolve rejecter : (RCTPromiseRejectBlock)reject) {
  [ShenaiSDK openMeasurementResultsPdfInBrowser];
  resolve(@(YES));
}

RCT_EXPORT_METHOD(sendMeasurementResultsPdfToEmail : (NSString *)email resolver : (RCTPromiseResolveBlock)
                      resolve rejecter : (RCTPromiseRejectBlock)reject) {
  [ShenaiSDK sendMeasurementResultsPdfToEmail:email];
  resolve(@(YES));
}

RCT_EXPORT_METHOD(requestMeasurementResultsPdfUrl : (RCTPromiseResolveBlock)resolve rejecter : (RCTPromiseRejectBlock)
                      reject) {
  [ShenaiSDK requestMeasurementResultsPdfUrl];
  resolve(@(YES));
}

RCT_EXPORT_METHOD(getMeasurementResultsPdfUrl : (RCTPromiseResolveBlock)resolve rejecter : (RCTPromiseRejectBlock)
                      reject) {
...
RCT_EXPORT_METHOD(requestMeasurementResultsPdfBytes : (RCTPromiseResolveBlock)resolve rejecter : (RCTPromiseRejectBlock)
                      reject) {
  [ShenaiSDK requestMeasurementResultsPdfBytes];
  resolve(@(YES));
}

RCT_EXPORT_METHOD(getMeasurementResultsPdfBytes : (RCTPromiseResolveBlock)resolve rejecter : (RCTPromiseRejectBlock)
                      reject) {
